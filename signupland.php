    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top sticky" id="navbar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="https://pcsales.io/signup.html" class="btn btn-info btn-sm navbar-btn my-lg-0 my-2">Sign Up</a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        <div class="hero-wrapper text-white-50 text-center">
                            ...
                            <div class="pt-2">
                                <a href="https://pcsales.io/index.html" class="btn btn-light mr-2">Return to Home</a>
                            </div>
