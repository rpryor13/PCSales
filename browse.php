        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ml-auto navbar-center mt-lg-0 mt-2" id="navbar-navlist">
                    <li class="nav-item">
                        <a href="https://pcsales.io/index.html" class="nav-link" id="scrollElement">Home</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row position-relative">
                <div class="col-lg-7 col-md-5">
                    <div class="hero-4-content mt-md-5">
                        <br>
                        <h1 class="hero-4-title fw-bold"><?php echo $intCount?> stored deals</h1>
                        <h2 class="fw-normal mb-4">Browse past deals quick and easy</h2>
                        <span class="title-line position-relative"></span>
                        <p class="text-muted mb-4 mt-5">
                            What parts are you looking for today?
                            <form name = "frmEmail" action ="browseland.php" method ="get">
                                ...
                                <label style="fontsize: 12"><input type="checkbox" name="chkALL" value="1"> All Parts (click here if you'd like to see all entries listed by date)</label><br><br> 
